        ...
        <div className="w-1/2 mt-[25px]">
          ...
          <div className="flex flex-col">
            <span className="flex flex-wrap text-justify">
              ...
              <p className="mb-3">Let&apos;s connect and bring ideas to life through code!</p>
              <p className="font-semibold">This site is still under construction, and responsive design will be implemented soon to enhance the user experience across all devices.</p>  
